...
'''
CRUD de modelo payments_user con cada funcion la parte de list y create sera para el usaario los demas
metodos para el admin el throller se aplicara al metodo list
'''
